...
void shady_physics_move_z(struct shady_toplevel *toplevel, float delta, float min_z, float max_z);
#else
...
static inline void shady_physics_move_z(struct shady_toplevel*t,float d,float mn,float mx){(void)t;(void)d;(void)mn;(void)mx;}
