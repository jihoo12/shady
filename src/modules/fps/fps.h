...
#if SHADY_HAS_FPSbool shady_fps_toggle(struct shady_server *server);
...
#elsestatic inline bool shady_fps_is_holding(const struct shady_server*s,const struct shady_toplevel*t){(void)s;(void)t;return false;}
