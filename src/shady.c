...
static void focus_toplevel(struct shady_toplevel *toplevel) {
...
static void seat_request_set_selection(struct wl_listener *listener, void *data) {
	 ...
	 * ignore such requests if they so choose, but in shady we always honor
	 */
	struct shady_server *server = wl_container_of(
...
static struct shady_toplevel *desktop_toplevel_at(
	 ...
	 * surface in the surface tree of a shady_toplevel. */
	...
	*surface = scene_surface->surface;
	/* Find the node corresponding to the shady_toplevel at the root of this
...
static void reset_cursor_mode(struct shady_server *server) {
...
static void xdg_toplevel_commit(struct wl_listener *listener, void *data) {
	...
	if (toplevel->xdg_toplevel->base->initial_commit) {
		 ...
		 * reply with a configure so the client can map the surface. shady
...
static void xdg_toplevel_request_maximize(
	 ...
	 * decorations. shady doesn't support maximization, but to conform to
...
static void server_new_xdg_toplevel(struct wl_listener *listener, void *data) {
	...
	/* Allocate a shady_toplevel for this surface */
...
static void xdg_popup_commit(struct wl_listener *listener, void *data) {
	...
	if (popup->xdg_popup->base->initial_commit) {
		 ...
		 * shady sends an empty configure. A more sophisticated compositor
...
int main(int argc, char *argv[]) {
	...
	/* The backend has connected using the host environment. Only children
	 * launched as clients should receive our display name. */
